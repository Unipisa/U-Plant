...
namespace UPlant.Controllers
{
    public class ProvenienzeController : BaseController
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ordinesuccessivo"] = StaticUtils.GeneraSuccessivo(_context.Provenienze.OrderBy(x => x.ordinamento).LastOrDefault().ordinamento);//da il numero successivo anche se stringa se il valore è 1 ,2 se viene espresso in alfabetico per ora da vuoto
            return View();
        }
