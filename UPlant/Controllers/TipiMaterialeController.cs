...
namespace UPlant.Controllers
{
    public class TipiMaterialeController : BaseController
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ordinesuccessivo"] = StaticUtils.GeneraSuccessivo(_context.TipiMateriale.OrderBy(x => x.ordinamento).LastOrDefault().ordinamento);//da il numero successivo anche se stringa se il valore è 1 ,2 se viene espresso in alfabetico per ora da vuoto
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("id,organizzazione,descrizione,ordinamento")] TipiMateriale tipiMateriale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("id,organizzazione,descrizione,ordinamento")] TipiMateriale tipiMateriale)
        {
