...
namespace UPlant.Controllers
{
    public class FornitoriController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("id,organizzazione,descrizione,descrizione_en,note,attivo")] Fornitori fornitori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("id,organizzazione,descrizione,descrizione_en,note,attivo")] Fornitori fornitori)
        {
            if (id != fornitori.id)
            {
                return NotFound();
