...
namespace UPlant.Controllers
{
    public class SessoController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("id,descrizione,organizzazione")] Sesso sesso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("id,descrizione,organizzazione")] Sesso sesso)
        {
            if (id != sesso.id)
            {
                return NotFound();
