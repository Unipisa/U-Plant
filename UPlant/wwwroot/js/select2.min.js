...
!function(){if(jQuery&&jQuery.fn&&jQuery.fn.select2&&jQuery.fn.select2.amd)var n=jQuery.fn.select2.amd;n.define("select2/i18n/it",[],function(){return{errorLoading:function(){return"I risultati non possono essere caricati."},inputTooLong:function(n){var t=n.input.length-n.maximum,i="Per favore cancella "+t+" caratter";return i+(1!==t?"i":"e")},inputTooShort:function(n){return"Per favore inserisci "+(n.minimum-n.input.length)+" o più caratteri"},loadingMore:function(){return"Caricando più risultati…"},maximumSelected:function(n){var t="Puoi selezionare solo "+n.maximum+" element";return t+=1!==n.maximum?"i":"o",t},noResults:function(){return"Nessun risultato trovato"},searching:function(){return"Sto cercando…"},removeAllItems:function(){return"Rimuovi tutti gli oggetti"}}});n.define;n.require}();